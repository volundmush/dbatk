...
namespace dbat::cstat {
    ...
    constexpr std::size_t NUM_CHAR_STATS = 11;

    class BaseCharacterStat : public BaseStat<Character, NUM_CHAR_STATS> {
    public:
        std::array<double, NUM_CHAR_STATS>& getStorage(const std::shared_ptr<Character>& obj) override;
    };
    ...
    public:
        ...
        [[nodiscard]] double calcEffective(const std::shared_ptr<Character>& obj, std::unordered_map<std::size_t, double>& cache) override;
    };
