...
namespace dbat {
    ...
    struct Command : BaseCommand {
        ...
        [[nodiscard]] virtual bool isUsable(entt::entity ent) {return true;};
    };
    ...
    unsigned long long getCommandUll(entt::entity ent);

    std::vector<std::pair<std::string, Command*>>& getSortedCommands(entt::entity ent);
